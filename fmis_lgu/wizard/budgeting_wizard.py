...
class BudgetingReport(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        return self.env['report'].get_action(self, 'budgeting.appstmt_report_viewnew', data=data)
        ...
        query = ("""
                ...
                """ + cond + """ 
                    ...
                    SELECT 'PR' source, budgeting_prdet.amount, 
                                budgeting_pr.date, 
                                budgeting_pr.name,
                                budgeting_pr.date_approved,
                                case when budgeting_obr.name is not Null then
